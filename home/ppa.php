      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="ppa.php">PPA</a></li>
  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content" >
        ...
        <?php $linkages = DB::query('SELECT * FROM ppa WHERE isPublished=true'); ?>
