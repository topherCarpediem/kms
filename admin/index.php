...
if(isset($_POST['submit-form'])){
  try{
    if(File::checkformat($_FILES['document']['tmp_name'])){
      ...
      $data = array('filepath' => $target_file, 'extension' => $extension);
      ...
      //var_dump($table);
      //var_dump($basename);
      $param = array(':title'=> $_POST['title'], ':author' => $_POST['author'], ':description'=> $_POST['description'], 'category'=>$column, ':isPublished'=> false, ':filename'=>$_FILES['document']['name'], ':filepath'=>$target_file, ':content_type'=>$_FILES['document']['type'], ':extension'=>$extension );
      
      //DB::query("INSERT INTO " . $table . "VALUES(\'\', :title, :author, :description, :category, :isPublished, :filename, :filepath, :content_type, :extension)", $param);
      DB::query(sprintf("INSERT INTO %s (title, author, description, category, isPublished, filename, filepath, content_type, extension ) VALUES(:title, :author, :description, :category, :isPublished, :filename, :filepath, :content_type, :extension)", $table), $param);
       array_push($success, 'File Uploadeded Successfully to ' . strtoupper($table) . ' with a tag of ' . $column);
    }else{
...
<head>
  ...
  <title>K.M.S ADMIN | Dashboard</title>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <img src="<?= $res[0]['image'] ?>" style="cursor: pointer;" id="user-profile" class="img-circle" alt="User Image">
                  <p>
          ...
          <div class="box box-primary">
            ...
            <form role="form" action"index.php" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <button type="submit" name="submit-form" class="btn btn-primary">Upload</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <center>
                ...
                <img src="<?= $res[0]['image'] ?>" class="img-circle" alt="User Image" style=" cursor: pointer; width: 160px; height: 160px " ><br>
              </center>
              <center>
